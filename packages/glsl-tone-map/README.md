...
[![dependencies](https://img.shields.io/librariesio/release/npm/glsl-tone-map)](https://github.com/dmnsgn/shaders-tone-map/blob/main/packages/glsl-tone-map/package.json)
...
Each operator also ships as a plain `.glsl` file (eg. `glsl-tone-map/aces.glsl`) for bundlers that load shaders as raw text.
